...
export const techStack = {
  html: { name: "HTML", image: img.html, shadow_color: "#e34c26" },
  css: { name: "CSS", image: img.css, shadow_color: "#2965f1" },
  js: { name: "JavaScript", image: img.js, shadow_color: "#F0DB4F" },
  ...
  sass: { name: "Sass", image: img.sass, shadow_color: "#cc6699" },
  styled: { name: "Styled", image: img.styled, shadow_color: "#ffd966" },
  material: {
    name: "Material UI",
    image: img.material,
    shadow_color: "#3178C6",
  ...
  // socket: { name: "Socket.io", image: img.socket },

  // git: { name: "Git", image: img.git },
