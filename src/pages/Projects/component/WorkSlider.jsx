                    ...
                    <div className="px-6 py-4">
                      ...
                      {data.project_link && (
                        <a
                          ...
                          target="_blank"
                          rel="noreferrer"
                          class=" relative ml-1 inline-flex items-center justify-center mt-4 p-[1.5px] mb-1 me-1 overflow-hidden text-sm rounded-lg group bg-indigo-500 hover:bg-indigo-600 hover:text-white dark:text-white">
                          <span class="relative px-3 py-0.5 transition-all ease-in duration-175 bg-white dark:bg-gray-900 rounded-md group-hover:bg-opacity-0 flex items-center gap-2">
                            <FaCode /> Code
                          </span>
                        </a>
