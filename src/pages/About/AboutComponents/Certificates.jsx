    ...
    <div className="py-2 px-3 xl:px-0 flex flex-col gap-y-2 xl:gap-y-4 items-start xl:items-start transition-all delay-150 w-full">
      <ol className="relative">
        <li className="mb-6 ms-8">
          ...
          <h3 className="flex items-center justify-between mb-1 text-xl font-semibold  dark:text-cyan-500 w-full ml-2 ">
        ...
        <li className="mb-6 ms-8">
          ...
          <h3 className="flex items-center justify-between mb-1 text-xl font-semibold  text-blue-500 w-full ml-2">
